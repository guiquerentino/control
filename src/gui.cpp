...
void App::CreateUI(){hwnd=CreateWindowExW(0,L"ControlWnd",L"Control",WS_OVERLAPPEDWINDOW,100,100,460,320,nullptr,nullptr,GetModuleHandleW(nullptr),this);font=CreateFontW(18,0,0,0,FW_NORMAL,FALSE,FALSE,FALSE,DEFAULT_CHARSET,OUT_DEFAULT_PRECIS,CLIP_DEFAULT_PRECIS,DEFAULT_QUALITY,DEFAULT_PITCH|FF_DONTCARE,L"Segoe UI");CreateWindowW(L"BUTTON",L"Pause",WS_CHILD|WS_VISIBLE,10,230,100,30,hwnd,(HMENU)1,GetModuleHandleW(nullptr),nullptr);CreateWindowW(L"BUTTON",L"Resume",WS_CHILD|WS_VISIBLE,120,230,100,30,hwnd,(HMENU)3,GetModuleHandleW(nullptr),nullptr);CreateWindowW(L"BUTTON",L"Change Password",WS_CHILD|WS_VISIBLE,230,230,150,30,hwnd,(HMENU)4,GetModuleHandleW(nullptr),nullptr);CreateWindowW(L"LISTBOX",nullptr,WS_CHILD|WS_VISIBLE|LBS_NOTIFY|WS_VSCROLL,10,10,410,200,hwnd,(HMENU)2,GetModuleHandleW(nullptr),nullptr);for(int id=1;id<=4;++id)SendMessageW(GetDlgItem(hwnd,id==4?4:id),WM_SETFONT,(WPARAM)font,TRUE);SendMessageW(GetDlgItem(hwnd,2),WM_SETFONT,(WPARAM)font,TRUE);ShowWindow(hwnd,SW_SHOW);UpdateButtons();}
